...
import { PROBLEM_POINTS } from '@/lib/data'

const icons = [Users, Search, Target]
  ...
  return (
    <section className="py-32 px-6 relative">
      <div className="max-w-6xl mx-auto">
        ...
        >
          Ton réseau vaut de l'or. <br />
          <span className="text-neutral-300">Mais il est enfoui.</span>
        </motion.h2>
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="w-10 h-10 rounded-full bg-neutral-800 flex items-center justify-center mb-6 text-blue-400 group-hover:bg-blue-900/50 transition-colors">
                    <Icon size={20} strokeWidth={1.5} className="drop-shadow-[0_0_8px_rgba(59,130,246,0.5)]" />
                  </div>
